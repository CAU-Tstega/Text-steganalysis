...
parser.add_argument('-embed-dim', type=int, default=256, \
					help='number of embedding dimension [defualt:256]')
parser.add_argument('-hidden-size', type=int, default=200, \
					help='the number of hidden unit [defualt:200]')
parser.add_argument('-dropout', type=float, default=0.9, \
					help='the probability for dropout [defualt:0.9]')
...
# model
model = BiLSTM_Dense.BiLSTM_Dense(args)
...
# Loading the trained model to continue training
